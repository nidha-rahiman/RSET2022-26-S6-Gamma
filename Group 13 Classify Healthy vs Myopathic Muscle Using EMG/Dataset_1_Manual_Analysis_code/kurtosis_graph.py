...
plt.title("Kurtosis of EMG Signal Segments")
plt.xlabel("File (F01 to F05)")
plt.ylabel("Kurtosis")

# Set x-ticks to just F01 to F05
...
plt.show()
print("kurtosis_plot.png saved successfully.")

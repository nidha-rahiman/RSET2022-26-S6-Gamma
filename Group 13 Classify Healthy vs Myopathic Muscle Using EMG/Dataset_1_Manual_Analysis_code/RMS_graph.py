...
# Load the RMS.csv
df = pd.read_csv("RMS.csv", index_col=0)
...
plt.title("RMS of EMG Segments (P01–P06 Healthy, P07–P12 Myopathy)")
plt.grid(True, linestyle='--', alpha=0.5)
plt.legend()
plt.tight_layout()
plt.savefig("RMS_plot.png", dpi=300)
plt.show()

print("📊 RMS_plot.png saved.")

...
# Load the SSI.csv
df = pd.read_csv("SSI.csv", index_col=0)
...
plt.title("SSI of EMG Segments (P01–P06 Healthy, P07–P12 Myopathy)")
plt.grid(True, linestyle='--', alpha=0.5)
plt.legend()
plt.tight_layout()
plt.savefig("SSI_plot.png", dpi=300)
plt.show()

print("📊 SSI_plot.png saved.")

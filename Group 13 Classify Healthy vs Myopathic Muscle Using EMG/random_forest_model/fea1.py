...
def process_dataset(input_dir, output_dir, fs=1000):
    ...
    for file in os.listdir(input_dir):
        if file.endswith(".txt") or file.endswith(".csv"):
            ...
            try:
                # Read CSV using pandas to handle missing values
                ...
                signal = df.iloc[:, 1].astype(float).values  # Ensure numerical format
...
# Example usage
process_dataset("/home/user/emg/segment", "/home/user/emg/output_folder1")
